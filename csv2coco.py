...
np.random.seed(41) 
classname_to_id  ={"plane":1, "baseball-diamond":2, "bridge":3, "ground-track-field":4, "small-vehicle":5, "large-vehicle":6, "ship":7,
                    "tennis-court":8,"'basketball-court":9, "storage-tank":10,  "soccer-ball-field":11, "roundabout":12, "harbor":13,
                    "swimming-pool":14, "helicopter":15}
...
if __name__ == '__main__':
    ...
    train_keys, val_keys = train_test_split(total_keys, test_size=0.3) #7:3划分
